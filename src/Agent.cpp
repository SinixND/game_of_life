...
void Agent::SetStatusCurrent(bool statusCurrent)
{
    statusCurrent_ = statusCurrent;
}
...
void Agent::SetStatusOutdated(bool statusOutdated)
{
    statusOutdated_ = statusOutdated;
}
...
void Agent::EreaseVitality() { vitality_ = 0; }
